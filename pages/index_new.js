            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12 max-w-4xl mx-auto">
                <div className="text-center">
                  ...
                  <div className="text-sm text-blue-100">Jenis Diagnosis</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold">98%</div>
                  <div className="text-sm text-blue-100">Akurasi Model</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold">&lt;30s</div>
                  <div className="text-sm text-blue-100">Waktu Proses</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold">24/7</div>
                  <div className="text-sm text-blue-100">Tersedia</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {isProcessing && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-8 max-w-md mx-4 text-center">
                ...
                <h3 className="text-xl font-semibold mb-4">Sedang Memproses Diagnosis</h3>
